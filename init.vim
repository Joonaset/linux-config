...
""".xml
	...
	autocmd FileType xml inoremap <leader>. <DELRNO><++></DELRNO><Esc>0:MultipleCursorsFind<Space>DELRNO<Enter>c
	" Set tabwidth to 2
	autocmd FileType xml set tabstop=2

""".xsd
	autocmd FileType xsd inoremap <leader>e <xsd:<++>><CR><++><Esc>k0/<++><CR>4xi
	" Set tabwidth to 2
